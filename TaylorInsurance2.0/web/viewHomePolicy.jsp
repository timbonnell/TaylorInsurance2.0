<%-- 
    Document   : viewHomePolicy
    Created on : Mar 29, 2017, 8:53:51 PM
    Author     : tim
--%>

<%@page import="DAO.DatasetDAO"%>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        ...
                        <div style="padding: 20px;"  mdl-card--expand>
                            <p>Customer ID: <%= newBusinessProcessManager.getCustomer().getId()%>
                                ...
                                <br>
                                <%= newBusinessProcessManager.getHouse(newBusinessProcessManager.getHousePolicy(homePolicyID).getAssociatedQuote().getProperty().getHouseId()).getAddress()%></p>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title_info mdl-card--expand">
                            <h3 class="mdl-card__title_home-text">House Information</h3>
                        </div>

                        <div style="padding: 20px;"  mdl-card--expand>
                            <p>Year Built: <%= newBusinessProcessManager.getHouse(newBusinessProcessManager.getHousePolicy(homePolicyID).getAssociatedQuote().getProperty().getHouseId()).getYear()%></p>
                            <p>Building Type: <%=DatasetDAO.resolveDatasetLabel(newBusinessProcessManager.getHouse(newBusinessProcessManager.getHousePolicy(homePolicyID).getAssociatedQuote().getProperty().getHouseId()).getType())%></p>
                            <p>Heating Source: <%= DatasetDAO.resolveDatasetLabel(newBusinessProcessManager.getHouse(newBusinessProcessManager.getHousePolicy(homePolicyID).getAssociatedQuote().getProperty().getHouseId()).getHeating())%></p>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        ...
                        <br>
                        <b style="padding-left: 10px;">Yearly Premium: <%= newBusinessProcessManager.getHousePolicy(homePolicyID).getPremium()%></b>
                        <br>
                        <b style="padding-left: 10px;">Next Payment Date: <%= newBusinessProcessManager.getHousePolicy(homePolicyID).getExpiryDate() %></b>
                        <div class="mdl-card__actions mdl-card--border">
                            <form class="form-horizontal" action="userprofile.jsp">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" type="submit">Back to My Profile</button>
                            </form>
                        </div>
