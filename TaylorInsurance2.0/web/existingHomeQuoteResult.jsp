            ...
            <div class="row">
                    ...
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        ...
                        <div style="padding: 20px;"  mdl-card--expand>
                            <p>Customer ID: <%= newBusinessProcessManager.getCustomer().getId()%>
                                ...
                                <br>
                                <%= newBusinessProcessManager.getHouse(HouseID).getAddress()%></p>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        ...
                        <div style="padding: 20px;"  mdl-card--expand>
                            <p>Year Built: <%= newBusinessProcessManager.getHouse(HouseID).getYear()%></p>
                            <p>Building Type: <%=DatasetDAO.resolveDatasetLabel(newBusinessProcessManager.getHouse(HouseID).getType())%></p>
                            <p>Heating Source: <%= DatasetDAO.resolveDatasetLabel(newBusinessProcessManager.getHouse(HouseID).getHeating())%></p>
                        </div>
                    </div>
