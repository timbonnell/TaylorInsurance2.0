            ...
            <div class="row">
                    ...
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        ...
                        <div style="padding: 20px;"  mdl-card--expand>
                            <p>Customer ID: <%= newBusinessProcessManager.getCustomer().getId()%>
                                ...
                                <br>
                                <%= newBusinessProcessManager.getHouse(newBusinessProcessManager.getHouseQuote(homeQuoteID).getProperty().getHouseId()).getAddress()%></p>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="demo-card-square mdl-card mdl-shadow--2dp">
                        ...
                        <div style="padding: 20px;"  mdl-card--expand>
                            <p>Year Built: <%= newBusinessProcessManager.getHouse(newBusinessProcessManager.getHouseQuote(homeQuoteID).getProperty().getHouseId()).getYear()%></p>
                            <p>Building Type: <%=DatasetDAO.resolveDatasetLabel(newBusinessProcessManager.getHouse(newBusinessProcessManager.getHouseQuote(homeQuoteID).getProperty().getHouseId()).getType())%></p>
                            <p>Heating Source: <%= DatasetDAO.resolveDatasetLabel(newBusinessProcessManager.getHouse(newBusinessProcessManager.getHouseQuote(homeQuoteID).getProperty().getHouseId()).getHeating())%></p>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="demo-card-square mdl-card mdl-shadow--2dp">
                                    ...
                                    <b style="padding: 5px;">Yearly Premium: $<%=newBusinessProcessManager.getHouseQuote(homeQuoteID).getTotalPremium()%></b>
                                    <b style="padding: 5px;">Expiry Date: <%=newBusinessProcessManager.getHouseQuote(homeQuoteID).getExpiryDate() %></b>
